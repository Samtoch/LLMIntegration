...
namespace LLMIntegrations.Services.External
{
    public class ExternalServices : IExternalServices
    {
        ...
        public Task<Response> ChatOpenai(string text)
        {
        ...
        public Task<ResponseFromLlama> ChatLlama(string text)
        {
            ...
            try
            {
                ...
                var msg = new RequestForLlama() { Model = _configsLlama.Model, Prompt = prompt, Stream = Convert.ToBoolean(_configsLlama.Stream) };
        ...
        public Task<ResponseFromLlama> VerifyLanguage(string text)
        {
            var response = new ResponseFromLlama();
            try
            {
